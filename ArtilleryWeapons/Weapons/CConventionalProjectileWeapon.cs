...
namespace ArtilleryWeapons.Weapons {
    ...
    // Class representing a CConventionalProjectile weapon, implementing the IWeapon interface
    public class CConventionalProjectileWeapon : IWeapon {
        ...
        public CConventionalProjectileWeapon(IMetalCasingBlueprint metalCasing,
