...
namespace ArtilleryWeapons.Weapons {
    ...
    // Class representing a CRocketProjectile weapon, implementing the IWeapon interface
    public class CRocketProjectileWeapon : IWeapon {
        ...
        public CRocketProjectileWeapon(IMetalCasingBlueprint metalCasing,
