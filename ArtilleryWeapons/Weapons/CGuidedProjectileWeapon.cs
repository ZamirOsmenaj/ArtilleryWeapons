...
namespace ArtilleryWeapons.Weapons {
    ...
    // Class representing a CGuidedProjectile weapon, implementing the IWeapon interface
    public class CGuidedProjectileWeapon : IWeapon {
        ...
        public CGuidedProjectileWeapon(IMetalCasingBlueprint metalCasing,
