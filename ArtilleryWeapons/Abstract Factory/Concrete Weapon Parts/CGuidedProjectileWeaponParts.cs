...
namespace ArtilleryWeapons {
    ...
    public class CGuidedProjectileMetalCasingBlueprint : IMetalCasingBlueprint {
        ...
        public CGuidedProjectileMetalCasingBlueprint(MetalCasingType metalCasing, MetalCasingShape metalCasingShape, double weightKG, double thicknessMM) {
    ...
    public class CGuidedProjectileExplosiveBlueprint : IExplosiveBlueprint {
        ...
        // Constructor to initialize the properties
        public CGuidedProjectileExplosiveBlueprint(ExplosiveType explosive, double weightKG) {
    ...
    public class CGuidedProjectileGuidanceKitBlueprint : IGuidanceKitBlueprint {
        ...
        // Constructor to initialize the properties
        public CGuidedProjectileGuidanceKitBlueprint(GuidanceType guidance, double sensitivity) {
    ...
    public class CGuidedProjectileDetonationBlueprint : IDetonationBlueprint {
        ...
        // Constructor to initialize the properties
        public CGuidedProjectileDetonationBlueprint(DetonationType detonation, double accuracy) {
    ...
    public class CGuidedProjectileLauncherBlueprint : ILauncherBlueprint {
        ...
        // Constructor to initialize the properties
        public CGuidedProjectileLauncherBlueprint(LauncherType launcher, double rangeKM) {
