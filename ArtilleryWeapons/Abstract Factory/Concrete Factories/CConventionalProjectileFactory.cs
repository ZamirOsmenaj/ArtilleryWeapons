...
namespace ArtilleryWeapons {
    ...
    // Class to create various parts of the Conventional Projectile weapon using a factory design pattern
    public class CConventionalProjectileFactory : IWeaponPartsFactory {

        // Private field to hold the weapon blueprint
        IWeaponBlueprint? blueprint;

        // Constructor to initialize the factory with a specific version of the Conventional Projectile weapon
        public CConventionalProjectileFactory(int ConventionalProjectileVersion) {
            // Retrieve the blueprint for the specified version from the repository
            blueprint = BlueprintRepositoryRND.Instance.GetBlueprint(WeaponFamilies.Conventional, ConventionalProjectileVersion);
        }
        ...
        public IMetalCasingBlueprint CreateMetalCasing() {
            return new CConventionalProjectileMetalCasingBlueprint(
        ...
        public IExplosiveBlueprint CreateExplosive() {
            return new CConventionalProjectileExplosiveBlueprint(
        ...
        public IGuidanceKitBlueprint CreateGuidance() {
            return new CConventionalProjectileGuidanceKitBlueprint(
        ...
        public IDetonationBlueprint CreateDetonation() {
            return new CConventionalProjectileDetonationBlueprint(
        ...
        public ILauncherBlueprint CreateLauncher() {
            return new CConventionalProjectileLauncherBlueprint(
